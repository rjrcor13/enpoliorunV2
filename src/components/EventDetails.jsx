...
import {
	...
	Shirt,
	Tag,
	Trophy, // New Icon for pricing
	User, // New Icon for student
	Wallet, // New Icon for regular
} from 'lucide-react';
import React from 'react';
import { Button } from './ui/button';
...
const distancesData = [
	{
		...
		registrationFee: {
			earlyBird: '899',
			student: '799', // Corrected typo in data structure: 'strudent' -> 'student'
			regular: '999',
		},
	},
	{
		...
		registrationFee: {
			earlyBird: '1199', // Adjusted fees for distinction
			student: '1099',
			regular: '1299',
		},
	},
	{
		...
		registrationFee: {
			earlyBird: '1499', // Adjusted fees for distinction
			student: '1399',
			regular: '1599',
		},
	},
...
const EventDetails = () => {
	...
	return (
		<section id="details" className="py-20 bg-white bg-[#000742]_">
			<div className="container mx-auto px-4 ">
				<motion.div
					initial={{ opacity: 0, y: 50 }}
					whileInView={{ opacity: 1, y: 0 }}
				...
				<div className="grid sm:grid-cols-3 grid-cols-1 gap-4   overflow-hidden rounded-xl md:p-5 p-0 bg-white_">
					{distancesData.map((category, index) => (
						<motion.div
							key={index}
							initial={{ opacity: 0, scale: 0.95 }}
						...
						>
							...
							<div
								...
								id="details"
							>
								{/* --- NEW: REGISTRATION FEE SECTION --- */}
								<motion.h3
									variants={itemVariants}
									className="text-sm sm:text-md font-bold mb-3 pb-1 border-b border-white/30 text-shadow-lg"
								>
									REGISTRATION FEE
								</motion.h3>
								<motion.div
